import sqlite3, json, os, sys, shutil, webbrowser, tempfile
...
databaseInputFile = os.path.join(userDirectory, "Library", "Safari", "History.db")
...
sqlHistoryItems = "\
	SELECT history_items.id, history_items.url, history_visits.title, MAX(CAST(1000 * history_visits.visit_time AS INT) + 978307200000), history_items.visit_count \
	FROM history_visits \
